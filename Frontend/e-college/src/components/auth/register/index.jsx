...
const Register = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            // Call function to create user with email and password and save to Firestore
            ...
            setIsRegistering(false) // Reset the loading state
        }
    }
                    ...
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onFocus={() => setErrorMessage('')} // Clear error when user starts typing
